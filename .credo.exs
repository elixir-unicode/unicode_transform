# Credo configuration for unicode_transform.
#
# Policy decisions:
#
# * `Design.AliasUsage` is disabled. Fully-qualified calls to modules such
#   as `Unicode.Transform.Rule` read more clearly at the call site than
#   opportunistic aliases.
#
# * `Refactor.Nesting` and `Refactor.CyclomaticComplexity` stay at their
#   defaults; naturally-branchy functions (transform rule dispatch) carry
